...
.. important::
   The company information (Company Name and Billing address) in your Gelato account *must* match the
   company information in your Odoo database in order for sales orders to be confirmed and sent to
   Gelato for fulfillment.
...
.. important::
   The `Print Images` field *must* be configured on the product before it can be ordered.
