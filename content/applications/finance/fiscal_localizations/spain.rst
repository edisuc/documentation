...
go to :menuselection:`Accounting --> Configuration --> Settings`, and select a **certificate** in the
:guilabel:`Veri\*Factu` section: Click :guilabel:`Manage certificates`, then click
